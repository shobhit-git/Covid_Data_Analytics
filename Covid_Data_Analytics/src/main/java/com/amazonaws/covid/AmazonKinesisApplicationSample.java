...
public final class AmazonKinesisApplicationSample {
	 ...
	 * location (C:\\Users\\SHOBHITAGRAWAL\\.aws\\credentials) where the sample code
	...
	public static final String APPLICATION_STREAM_NAME = "Covid-Stream";
	...
	private static void init() {
		...
		try {
			...
			throw new AmazonClientException("Cannot load the credentials from the credential profiles file. "
					...
					+ "location (C:\\Users\\SHOBHITAGRAWAL\\.aws\\credentials), and is in valid format.", e);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		KinesisClientLibConfiguration kinesisClientLibConfiguration = new KinesisClientLibConfiguration(
				SAMPLE_APPLICATION_NAME, APPLICATION_STREAM_NAME, credentialsProvider, workerId);
		...
		System.out.printf("Running %s to process stream %s as worker %s...\n", SAMPLE_APPLICATION_NAME,
				APPLICATION_STREAM_NAME, workerId);
	...
	public static void deleteResources() {
		...
		try {
			kinesis.deleteStream(APPLICATION_STREAM_NAME);
